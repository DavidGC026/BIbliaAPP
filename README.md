...
- Documentación de referencia: [`docs-mobile/README.md`](docs-mobile/README.md) — incluye el [plan maestro de mejoras](docs-mobile/20-plan-maestro-mejoras-generales.md) y la última iteración ([notas recientes en Inicio](docs-mobile/21-inicio-recientes-inteligentes.md)).
