...
|--------|------|----------|-------|
| Hecho | Notas profesionales | Convertir Notas en una herramienta general, util aunque no sea solo para estudio biblico. | Busqueda, libretas, acciones rapidas, mover notas, fijar notas, compartir, insertar versiculos y diccionario. La insercion de referencias cruzadas se retiro del editor en julio 2026 (ver doc 17). |
