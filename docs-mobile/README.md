...
| [23-paridad-web-mobile-global.md](./23-paridad-web-mobile-global.md) | Shell móvil web global, tabbar flotante y componente `SegmentTabs` (incl. indicador de deslizamiento) |
| [24-reduccion-secciones-web.md](./24-reduccion-secciones-web.md) | Hubs Leer / Notas / Perfil, navegación reducida y uso de `SegmentTabs` |
