...
| [25-temas-visuales-y-dvg.md](./25-temas-visuales-y-dvg.md) | Temas móviles, selector visual, DVG admin y paridad web ([`docs/temas-visuales-web.md`](../docs/temas-visuales-web.md)) |
