...
| [23-paridad-web-mobile-global.md](./23-paridad-web-mobile-global.md) | Paridad visual del shell móvil web (tabbar, header, safe-area) |
| [24-reduccion-secciones-web.md](./24-reduccion-secciones-web.md) | Hubs de secciones (Leer, Notas, Perfil) y tab Planes en el lector |
