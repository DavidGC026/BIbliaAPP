...
| [23-paridad-web-mobile-global.md](./23-paridad-web-mobile-global.md) | Shell móvil global de la web (tabbar flotante, header, safe-area) |
| [24-reduccion-secciones-web.md](./24-reduccion-secciones-web.md) | Hubs de sección web (Leer, Notas, Perfil) y tabbar reducida |
