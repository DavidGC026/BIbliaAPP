...
| [16-editor-webview-teclado-seleccion.md](./16-editor-webview-teclado-seleccion.md) | «Seleccionar todo», foco del teclado y swatch **A** (color automático del tema) en el editor |
